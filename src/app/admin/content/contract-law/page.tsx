...
import { BookOpen, MessageSquare, Plus, Edit, Trash2, Eye, Save, Upload, FileText, AlertCircle } from 'lucide-react'
...
export default function ContractLawContentPage() {
  ...
  useEffect(() => {
    fetchContractLawContent()
  }, [])

  const fetchContractLawContent = async () => {
    try {
      setLoading(true)
      
      // Fetch Contract Law articles
  ...
  const validateArticleForm = (): string | null => {
    ...
    if (articleForm.content.length < 2000) return 'Content must be at least 2000 characters for comprehensive legal guidance'
    return null
  }
  ...
  const importContractLawContent = async () => {
    try {
      setSaving(true)
      setMessage(null)

      const response = await fetch('/api/admin/import-contract-law', {
        method: 'POST',
        headers: {
      ...
      if (result.success) {
        ...
        fetchContractLawContent() // Refresh the content
      } else {
        setMessage({
          type: 'error',
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Contract Law content...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Contract Law Content Management</h1>
              <p className="text-gray-600">Manage articles and Q&As for Contract Law practice area</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-600">{Math.max(0, 8 - articles.length)}</div>
              <p className="text-xs text-muted-foreground">
                Articles needed (Target: 8)
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="articles" className="space-y-6">
          ...
          <TabsContent value="articles" className="space-y-4">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-semibold">Contract Law Articles</h2>
              <div className="flex items-center space-x-2">
                <Button
                  onClick={importContractLawContent}
                  variant="outline"
                  disabled={saving}
            ...
            {showArticleForm && (
              <Card className="mb-6">
                <CardHeader>
                  ...
                  <CardDescription>
                    Create comprehensive legal content for Contract Law (minimum 2000 words)
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="e.g., Business Contracts in Singapore: Essential Legal Guide"
                        className="w-full"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Comprehensive legal content for Contract Law (minimum 2000 characters)"
                      rows={15}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="contract law, business agreements, singapore"
                        className="w-full"
                      />
                    </div>
                    <div>
              ...
              {articles.length === 0 && (
                <Card>
                  <CardContent className="text-center py-8">
                    ...
                    <p className="text-gray-500 mb-4">Create your first Contract Law article to get started.</p>
          ...
          <TabsContent value="qas" className="space-y-4">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-semibold">Contract Law Q&As</h2>
              <div className="flex items-center space-x-2">
                <Button
            ...
            {showQAForm && (
              <Card className="mb-6">
                <CardHeader>
                  ...
                  <CardDescription>
                    Create practical Q&A content for Contract Law
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="e.g., What makes a contract legally binding in Singapore?"
                      className="w-full"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Comprehensive answer with Singapore legal context (minimum 100 characters)"
                      rows={8}
                      className="w-full"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="contract law, business, singapore"
                        className="w-full"
                      />
                    </div>
                  </div>
              ...
              {qas.length === 0 && (
                <Card>
                  <CardContent className="text-center py-8">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">No Q&As Yet</h3>
                    <p className="text-gray-500 mb-4">Create your first Contract Law Q&A to get started.</p>
